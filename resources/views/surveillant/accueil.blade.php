...
<div class="row">
        ...
        <nav class="list-group m-t-1">
            ...
            <a class="list-group-item list-group-item-action " href="{{ route('mesClasses',['prof'=>$user ?? '']) }}" data-key="home" data-isexpandable="0" data-indent="0" data-showdivider="0" data-type="70" data-nodetype="0" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="myhome">
                <div class="m-l-0">
                    <div class="media">
                        <span class="media-left">
                            <i class="icon fa fa-table fa-fw mr-2" aria-hidden="true"></i>
                        </span>
                        <span class="media-body ">Lister les classes</span>
                    </div>
                </div>
            </a>
